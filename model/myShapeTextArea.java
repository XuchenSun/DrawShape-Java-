...
//TextArea	
public int textAreaLayoutX=500;
public int textAreaLayoutY=500;
public int textAreaMaxWidth=200;
public int textAreaMaxHeight=200;
public static int getCount(){
    return count;
}
public myShapeTextArea(){
	 objId=++count;
	 
	 System.out.println("TextArea is created!");
	 System.out.println("TextArea Id is "+objId);
